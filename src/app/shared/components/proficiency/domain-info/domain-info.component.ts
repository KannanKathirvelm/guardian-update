...
import { DomainTopicsModel, FwCompetenciesModel, SelectedCompetencyModel } from '@shared/models/competency/competency';
...
export class DomainInfoComponent implements AfterViewInit, OnInit {
  ...
  public topicCompetencyCounts: number;
  ...
  public ngOnInit() {
    ...
    this.domain.topics.forEach((topics) => competencyCount = competencyCount + topics.competencies.length);
    this.topicCompetencyCounts = competencyCount;
  }
